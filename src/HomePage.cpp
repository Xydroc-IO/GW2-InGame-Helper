...
namespace
{
	static constexpr const char* kHomePageVersion = "22";
      ...
      <section class="block">
        ...
        <div class="body">
          <div class="grid">
            ...
            <div class="card"><span class="cat">Cheat Sheets</span><span>Uber’s All-In-One, Raid Food, Utilities, Fractals, Sigils, Relics, Boons, CC, Wings, Garden</span></div>
