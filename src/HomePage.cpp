...
namespace
{
	static constexpr const char* kHomePageVersion = "21";
      ...
      <section class="block">
        ...
        <div class="body">
          <div class="grid">
            ...
            <div class="card"><span class="cat">Cheat Sheets</span><span>Raid Food, Utilities, Fractals, Sigils, Relics, Boons, CC, Wings, Garden</span></div>
