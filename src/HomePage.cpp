...
namespace
{
	static constexpr const char* kHomePageVersion = "24";
      ...
      <section class="block">
        ...
        <div class="body">
          <div class="grid">
            ...
            <div class="card"><span class="cat">Cheat Sheets</span><span>Hubs: Raid Prep, Squad Utility, Encounters, Fractals · plus individual sheets</span></div>
