      ...
      <section class="block">
        ...
        <div class="body">
          <div class="grid">
            ...
            <div class="card"><span class="cat">Guides</span><span>Living World, Progress, Mounts, Fractals, Raid Wings, Raid Boss, Strikes, Rifts, Achievements, Jumping Puzzles, PvP, WvW, TLDR</span></div>
