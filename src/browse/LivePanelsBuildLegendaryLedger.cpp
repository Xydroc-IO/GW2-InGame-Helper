...
a.card:hover{border-color:rgba(235,192,71,.55);border-left-color:#ffe08a}.avatar{width:2.25rem;height:2.25rem;border-radius:.375rem;background:rgba(235,192,71,.15);color:var(--purple-300);display:flex;align-items:center;justify-content:center;font-weight:600;flex-shrink:0}
