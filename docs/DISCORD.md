# :rocket: GW2 In-Game Helper — **v2.0.0.21**
...
**2,661** Browse entries you can search and open in-game:

- **Wiki** — thousands of GW2 Wiki pages (legendaries, armory, food, minis, upgrades, lifestyle, crafting, and more)
- **Guides** — Guildjen, MetaBattle, TLDR, raids / strikes / fractals / mounts / achievements
- **Builds** — MetaBattle, Gw2Skills, Accessibility Wars
- **Cheat Sheets** — 23 offline sheets (raid food, utilities, boons, wings, dailies, and more)
- **Tools** — gw2efficiency, timers, Wingman, KillProof, BLTC, **GW2.app**, and more
...
- **v2.0.0.21** — Browse: GW2.app under Tools (lists / database / vault / maps)
- **v2.0.0.20** — Allow site ads; remove Snow Crows (per request) → MetaBattle builds / raid guides
...
- Old favorites pinned to Snow Crows site IDs will go stale — re-star the MetaBattle entries
