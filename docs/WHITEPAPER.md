...
6. **Documentation lag.** This report tracks revision 2.2.0.14; future commits may land before the next sync.
...
## Appendix A — Quantitative constants (revision 2.2.0.14)

| Constant | Value |
|----------|-------|
| Addon version | 2.2.0.14 |
| Nexus signature | `HELP` / `0x48454C50` |
...
| Last sync | 2.2.0.14 — config/ state dir; favorites persist; side-rail brand title |
...
| How to cite (informal) | xydroc, “Embedding a Contemporary Chromium Browser in a Live Game Client,” GW2 In-Game Helper technical report, rev. 2.2.0.14, 2026. |
