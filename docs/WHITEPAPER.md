...
## Appendix A — Quantitative constants (revision 2.3.0.6)

| Constant | Value |
|----------|-------|
| Addon version | 2.3.0.6 |
| Nexus signature | `HELP` / `0x48454C50` |
...
| Last sync | 2.3.0.6 — Lady With Mounts Caledon GPS + compass overlay; helper 2247; live 86; home 2238; sites s2215; c2228; raid food 9; watchd w10; uc36 |
