...
## Appendix A — Quantitative constants (revision 2.1.0.1)

| Constant | Value |
|----------|-------|
| Addon version | 2.1.0.1 |
| Nexus signature | `HELP` / `0x48454C50` |
...
| Helper / home / sites stamps | 2101 / 2101 / s2101 |
...
| Last sync | 2.1.0.1 — Lady Features, GPS width bias + world/screen avatar soft-hide, sticky GPS, UI scale, Nexus disable unload |
...
| How to cite (informal) | xydroc, “Embedding a Contemporary Chromium Browser in a Live Game Client,” GW2 In-Game Helper technical report, rev. 2.1.0.1, 2026. |
