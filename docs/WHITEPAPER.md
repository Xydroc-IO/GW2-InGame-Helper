...
## Appendix A — Quantitative constants (revision 2.2.4.10)

| Constant | Value |
|----------|-------|
| Addon version | 2.2.4.10 |
| Nexus signature | `HELP` / `0x48454C50` |
...
| Last sync | 2.2.4.10 — Cheat sheet open fix; helper 2243; live 74; home 2235; sites s2215; c2228; raid food 9; watchd w10; uc36 |
